...
**Story Forge** — это онлайн-игра для компании, в которой вы сочиняете истории вместе. Соберите друзей в общей комнате и по очереди добавляйте по одной строчке, пока из них не сложится целая история, — а затем послушайте, как она раскрывается, поворот за поворотом.
