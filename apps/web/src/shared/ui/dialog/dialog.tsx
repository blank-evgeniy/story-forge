...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "bg-deep-700/50 fixed inset-0 isolate z-50 backdrop-blur-sm",
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        "text-ink-muted *:[a]:text-brand-500 *:[a]:hover:text-brand-700 text-body *:[a]:underline *:[a]:underline-offset-3",
        className,
      )}
      {...props}
    />
