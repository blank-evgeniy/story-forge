...
const tabsListVariants = cva(
  cn(
    "group/tabs-list inline-flex w-fit items-center justify-center rounded-full p-1 text-ink-muted",
    "group-data-horizontal/tabs:h-11 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col group-data-vertical/tabs:rounded-xl",
...
function TabsTrigger({ className, ...props }: TabsPrimitive.Tab.Props) {
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        "relative inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-2 rounded-full border border-transparent! px-3 py-1",
        "text-sm font-bold whitespace-nowrap text-ink-muted",
        "transition-all",
        "hover:text-ink",
        ...
        "cursor-pointer after:absolute after:bg-brand-400 after:opacity-0 after:transition-opacity",
