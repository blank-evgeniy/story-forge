...
const avatarVariants = cva(
  cn(
    ...
    "after:absolute after:inset-0 after:rounded-full after:border after:border-line/60",
  ),
  {
    variants: {
      size: {
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        ...
        "bg-deep-400 text-sm font-bold text-surface group-data-[size=sm]/avatar:text-xs",
        className,
      )}
      {...props}
    />
  ...
  return (
    <span
      ...
      className={cn(
        ...
        "bg-brand-400 text-surface ring-2 ring-surface",
...
function AvatarGroupCount({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex size-8 shrink-0 items-center justify-center rounded-full text-sm font-bold ring-2 ring-surface",
