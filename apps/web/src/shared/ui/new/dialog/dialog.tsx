...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-deep-700/50 backdrop-blur-sm",
        "data-open:animate-in data-open:fade-in-0 duration-150",
        className,
      )}
      {...props}
    />
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-4 right-4 bg-surface-2"
                size="icon-sm"
              />
            }
          >
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        "text-sm text-ink-muted *:[a]:text-brand-500 *:[a]:underline *:[a]:underline-offset-3 *:[a]:hover:text-brand-700",
        className,
      )}
      {...props}
    />
