...
Создаёт по одной истории на каждого игрока, переводит комнату в статус `writing`, рассылает `iteration_ended` с номером первого раунда и через 3 секунды инициирует первый раунд.
